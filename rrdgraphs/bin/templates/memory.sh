...
"DEF:cache=$WORKING_DIR/rrd/memory.rrd:cache:AVERAGE" \
"DEF:buf=$WORKING_DIR/rrd/memory.rrd:buf:AVERAGE" \
"DEF:free=$WORKING_DIR/rrd/memory.rrd:free:AVERAGE" \
"DEF:total=$WORKING_DIR/rrd/memory.rrd:total:AVERAGE" \
"DEF:sused=$WORKING_DIR/rrd/memory.rrd:used:AVERAGE" \
