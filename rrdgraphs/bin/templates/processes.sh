...
"-w" "600" \
"--alt-autoscale-max" \
"DEF:total=$WORKING_DIR/rrd/processes.rrd:total:AVERAGE" \
"DEF:running=$WORKING_DIR/rrd/processes.rrd:running:AVERAGE" \
"DEF:sleeping=$WORKING_DIR/rrd/processes.rrd:sleeping:AVERAGE" \
"DEF:waiting=$WORKING_DIR/rrd/processes.rrd:waiting:AVERAGE" \
"DEF:starting=$WORKING_DIR/rrd/processes.rrd:starting:AVERAGE" \
"DEF:stopped=$WORKING_DIR/rrd/processes.rrd:stopped:AVERAGE" \
"DEF:zombie=$WORKING_DIR/rrd/processes.rrd:zombie:AVERAGE" \
