...
"-w" "600" \
"--slope-mode" \
"DEF:Total=$WORKING_DIR/rrd/${GRAPH}.rrd:Total:AVERAGE" \
"DEF:MFU=$WORKING_DIR/rrd/${GRAPH}.rrd:MFU:AVERAGE" \
"DEF:MRU=$WORKING_DIR/rrd/${GRAPH}.rrd:MRU:AVERAGE" \
"DEF:Anon=$WORKING_DIR/rrd/${GRAPH}.rrd:Anon:AVERAGE" \
"DEF:Header=$WORKING_DIR/rrd/${GRAPH}.rrd:Header:AVERAGE" \
"DEF:Other=$WORKING_DIR/rrd/${GRAPH}.rrd:Other:AVERAGE" \
