...
"DEF:ivoltage=$WORKING_DIR/rrd/ups.rrd:ivoltage:AVERAGE" \
"DEF:runtime=$WORKING_DIR/rrd/ups.rrd:runtime:AVERAGE" \
"DEF:OL=$WORKING_DIR/rrd/ups.rrd:OL:AVERAGE" \
"DEF:OF=$WORKING_DIR/rrd/ups.rrd:OF:AVERAGE" \
"DEF:OB=$WORKING_DIR/rrd/ups.rrd:OB:AVERAGE" \
"DEF:CG=$WORKING_DIR/rrd/ups.rrd:CG:AVERAGE" \
